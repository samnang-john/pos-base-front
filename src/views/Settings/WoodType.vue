...
const submitWoodType = async () => {
  if (woodTypeNameForm.value.name !== "") {
    try {
      ...
      getWoodTypes();
      closeModal();
      toast.success("Wood type created successfully!");
    } catch (error) {
      closeModal();
    ...
    <div class="overflow-x-auto rounded-lg border border-gray-100">
      <table class="w-full">
        ...
        <tbody class="divide-y divide-gray-200 bg-white">
          ...
          <tr
            v-else
            v-for="(wood, index) of listWoodTypes"
            :key="wood._id"
  ...
  >
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md" @click.stop>
      ...
      <div class="mb-4">
        ...
        >
        <input
          v-model="woodTypeNameForm.description"
          id="note"
          type="text"
