...
const submitWoodGrain = async () => {
  if (woodGrainNameForm.value.name !== "") {
    try {
      ...
      getWoodGrains();
      closeModal();
      toast.success("Wood grain created successfully!");
    } catch (error) {
      closeModal();
      console.log("Error=>", error);
      toast.error("Wood grain unsuccessfully!");
    }
  } else {
...
const onUpdate = async () => {
  try {
    ...
    getWoodGrains();
    closeModal();
    toast.success("Wood end grain updated successfully!");
  } catch (error) {
    console.log("Error=>", error);
    toast.error("Wood end grain update unsuccessfully!");
  }
};
...
const onDeleteWoodGrain = async (woodGrainId) => {
  try {
    ...
    getWoodGrains();
    toast.info("Wood end grain deleted successfully!");
  } catch (error) {
    toast.error("Wood end grain unsuccessfully!");
  }
};
</script>
...
<template>
  ...
  <div class="flex items-center justify-between mb-3">
    <h1 class="text-3xl font-semibold">Wood Grain</h1>
    <button
      type="button"
      @click="openModal()"
    ...
    <div class="overflow-x-auto rounded-lg border border-gray-100">
      <table class="w-full">
        ...
        <tbody class="divide-y divide-gray-200 bg-white">
          ...
          <tr
            v-else
            v-for="(wood, index) of listWoodGrains"
            :key="wood._id"
  ...
  >
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md" @click.stop>
      ...
      <div class="mb-4">
        ...
        <input
          v-model="woodGrainNameForm.name"
          id="woodGrainName"
          type="text"
          :class="[
      ...
      <div class="mb-4">
        ...
        >
        <input
          v-model="woodGrainNameForm.description"
          id="note"
          type="text"
